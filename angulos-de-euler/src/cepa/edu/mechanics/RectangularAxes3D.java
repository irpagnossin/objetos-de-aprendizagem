 ...
 */
class RectangularAxes3D extends TransformGroup {
        
    private Appearance[] appearance = new Appearance[3];
    private LineAttributes lineAttributes = null;
    private TransparencyAttributes transparencyAttributes = null;
    
    public void setLineAttributes( LineAttributes lineAttributes ){
        this.lineAttributes = lineAttributes;
        for ( byte i = 0; i < 3; i++ ) appearance[i].setLineAttributes(lineAttributes);
    }
    ...
    public void setTransparencyAttributes( TransparencyAttributes transparencyAttributes ){
        ...
        for ( byte i = 0; i < 3; i++ ) appearance[i].setTransparencyAttributes(transparencyAttributes);
    }
    
    public RectangularAxes3D( float L, Color3f[] color ){
