...
public class GraphCanvas extends Component{
    ...
    private float[] graphRange = new float[4];    
    
    public GraphCanvas( float[] graphRange, int[] canvasSize, int[] canvasMargin){
	...
	public int[] translate( float p[] ) throws IllegalArgumentException{
		/*	
        ...
        */        
		return new int[]{
            (int)((p[0] - graphRange[0]) * r[0]) + canvasMargin[0],
            (int)((graphRange[3] - p[1]) * r[1]) + canvasMargin[1]
        };
	}
    ...
    public float[] translate( int p[] ) throws IllegalArgumentException{
        /*
    ...
    public void setGraphRange( float[] graphRange ){
